...
public interface ExamRoomRepository extends JpaRepository<ExamRoom, Integer> {
    ...
    @Query("""
        ...
        WHERE st.userId = :userId
            ...
            AND ser.status = 1
    """)
    Long countActiveExamsTodayByUserId(@Param("userId") Integer userId, @Param("today") LocalDate today);
    ...
    @Query("""
        ...
        WHERE er.roomId = :roomId
            ...
            AND er.status = 1
    """)
    List<ExamRoom> findByRoomIdAndExamDate(@Param("roomId") Integer roomId, @Param("examDate") LocalDate examDate);
    ...
    """)
    List<ExamRoom> findByTeacherAndDate(@Param("teacherId") Integer teacherId, @Param("examDate") LocalDate examDate);
    ...
    """)
    List<com.bachld.backend.dto.response.ExamRoomResponse> findByStudent(@Param("studentId") Integer studentId);
    ...
    @Query("""
        ...
        ORDER BY er.examDate ASC, er.startTime ASC
    """)
    List<com.bachld.backend.dto.response.ExamRoomResponse> findByTeacher(@Param("teacherId") Integer teacherId);
