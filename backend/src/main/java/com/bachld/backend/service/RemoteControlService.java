...
public class RemoteControlService {
        ...
        .orElseThrow(
            () ->
                new IllegalArgumentException(
                    "Khong tim thay lop hoc co id: " + request.getClassId()));
  ...
  public void openWebsiteForStudent(
      Integer classId, Integer studentId, OpenWebsiteRequest request) {
    Student student =
        studentRepository
            .findById(studentId)
            .orElseThrow(
                () -> new IllegalArgumentException("Khong tim thay sinh vien co id: " + studentId));
    remoteCommandService.sendOpenWebsiteCommand(student.getUserId(), request.getWebsiteUrl());
  }
  ...
  public void sendMessageForStudent(
      Integer classId, Integer studentId, SendMessageRequest request) {
    Student student =
        studentRepository
            .findById(studentId)
            .orElseThrow(
  ...
  public void lockScreenForExamRoom(LockScreenExamRoomRequest request) {
    examRoomRepository
        .findById(request.getExamRoomId())
        .orElseThrow(
            () ->
                new IllegalArgumentException(
                    "Khong tim thay phong thi co id: " + request.getExamRoomId()));
    remoteCommandService.sendLockScreenCommand(request.getStudentUserId(), request.getActive());
  }
  ...
  public void openWebsiteForExamRoomStudent(
      Integer examRoomId, Integer studentId, OpenWebsiteRequest request) {
    Student student =
        studentRepository
            .findById(studentId)
            .orElseThrow(
  ...
  public void sendMessageForExamRoomStudent(
      Integer examRoomId, Integer studentId, SendMessageRequest request) {
    Student student =
        studentRepository
            .findById(studentId)
            .orElseThrow(
