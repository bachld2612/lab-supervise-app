...
public class UserService {
  ...
  public void update(UserUpdateRequest request, int userId) {
    User user =
        userRepository
            .findById(userId)
            .orElseThrow(
                () -> new IllegalArgumentException("Không tìm thấy người dùng có id: " + userId));
  ...
  public Page<UserResponse> getList(
      Pageable pageable, String keyword, Integer status, Integer roleType, Integer roleId) {
    if (keyword != null) {
  ...
  public void deleteById(int id) {
    User user =
        userRepository
            .findByIdAndStatus(id, Status.ACTIVE.getValue())
            .orElseThrow(
                () -> new IllegalArgumentException("Người dùng đã bị xoá hoặc không tồn tại"));
              ...
              .orElseThrow(
                  () ->
                      new IllegalArgumentException(
                          "Không tìm thấy sinh viên của người dùng có id: " + user.getId()));
