...
public class IncidentReportController {
  ...
  @AuthFilter(role = "STUDENT")
  public ResponseEntity<?> createForStudent(
  ...
  @AuthFilter(role = "TEACHER")
  public ResponseEntity<?> createForTeacher(
  ...
  @AuthFilter(role = "STUDENT")
  public ResponseEntity<?> updateForStudent(
      @PathVariable int id, @RequestBody @Valid IncidentReportStudentCreateRequest request) {
  ...
  @AuthFilter(role = "TEACHER")
  public ResponseEntity<?> updateForTeacher(
      @PathVariable int id, @RequestBody @Valid IncidentReportTeacherCreateRequest request) {
