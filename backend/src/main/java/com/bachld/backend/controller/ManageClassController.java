...
public class ManageClassController {
  ...
  public ResponseEntity<?> getList(
    ...
    return ResponseEntity.ok(
        new BaseResponse<>(
            HttpStatus.OK.value(), manageClassService.getList(pageable, keyword, status)));
  }
  ...
  public ResponseEntity<?> getById(@PathVariable int id) {
    return ResponseEntity.ok(
        new BaseResponse<>(HttpStatus.OK.value(), manageClassService.getById(id)));
  }
  ...
  public ResponseEntity<?> update(
      @RequestBody @Valid ManageClassUpdateRequest request, @PathVariable int id) {
