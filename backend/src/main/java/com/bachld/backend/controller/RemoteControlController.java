...
public class RemoteControlController {
  ...
  @AuthFilter(role = "TEACHER")
  public ResponseEntity<?> openWebsiteForClass(
      @PathVariable Integer id, @RequestBody @Valid OpenWebsiteRequest request) {
  ...
  @AuthFilter(role = "TEACHER")
  public ResponseEntity<?> sendMessageForClass(
      @PathVariable Integer id, @RequestBody @Valid SendMessageRequest request) {
    if (classService.getStudyStatus(id) != 1) {
      return ResponseEntity.unprocessableEntity()
          .body(new BaseResponse<>(HttpStatus.UNPROCESSABLE_ENTITY.value(), CLASS_NOT_ACTIVE));
    }
  ...
  @AuthFilter(role = "TEACHER")
  public ResponseEntity<?> lockScreenForExamRoom(
      @RequestBody @Valid LockScreenExamRoomRequest request) {
  ...
  @AuthFilter(role = "TEACHER")
  public ResponseEntity<?> openWebsiteForExamRoom(
      @PathVariable Integer id, @RequestBody @Valid OpenWebsiteRequest request) {
  ...
  @AuthFilter(role = "TEACHER")
  public ResponseEntity<?> sendMessageForExamRoom(
      @PathVariable Integer id, @RequestBody @Valid SendMessageRequest request) {
    if (examRoomService.getStudyStatus(id) != 1) {
      return ResponseEntity.unprocessableEntity()
          .body(new BaseResponse<>(HttpStatus.UNPROCESSABLE_ENTITY.value(), EXAM_NOT_ACTIVE));
