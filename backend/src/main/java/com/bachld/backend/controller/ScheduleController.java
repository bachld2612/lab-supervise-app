...
public class ScheduleController {
  ...
  public ResponseEntity<?> getList(
    ...
    return ResponseEntity.ok(
        new BaseResponse<>(
            HttpStatus.OK.value(), scheduleService.getList(pageable, keyword, status)));
  }
  ...
  public ResponseEntity<?> getById(@PathVariable int id) {
    return ResponseEntity.ok(
        new BaseResponse<>(HttpStatus.OK.value(), scheduleService.getById(id)));
  }
  ...
  public ResponseEntity<?> update(
      @RequestBody @Valid ScheduleUpdateRequest request, @PathVariable int id) {
