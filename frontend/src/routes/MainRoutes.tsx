...
const ScreenshotHistoryPage = Loadable(lazy(() => import('pages/screenshot/screenshot-history-page')));
  ...
  children: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          element: <ItCenterIncidentReportPage />
        },
        {
